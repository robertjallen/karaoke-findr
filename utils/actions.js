...
export function fetchVenuesByLatLng(location){
    ...
    // const karaoke =   
    return axios.get(`https://api.foursquare.com/v2/venues/search?client_id=${ID}&client_secret=${SECRET}&v=20180323&limit=2&query=${karaoke}&near=${location}&&radius=10000`)
}